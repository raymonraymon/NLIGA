...
%  'bc' is used for imposing boundary conditions, up to 16 boundary
...
bc = [2 3 2 3];      % [left boundary, bottom boundary, right boundary, top bounday]
...
beta = diag(freq).^0.5*b^2./(pi^2)*(rho*h/D0).^0.5;
...
title( 'Mode Shapes of a Square Plate', 'FontSize', 14', 'FontWeight', 'Bold') ;
axis off;
