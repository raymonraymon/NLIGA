function Lshape = geo_Lshape_2patch(L,P)
%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%
% Build a conforming two-patch L-shaped plane model
%   L - side length
%   P - bottom-left corner POINT coordinates with form of [x, y]
%   see the same model given in the function 'geo_L_shape' and 'geo_Lshape_3patch'
%
%  ---------------------------------------
...
coefs1 = zeros(4,2,2);
coefs1(:,:,1) = [x, y+2*L, 0, 1; x, y, 0, 1]';
coefs1(:,:,2) = [x+L, y+2*L, 0, 1; x+L, y+L, 0, 1]';
knots1{1} = [0 0 1 1];
knots1{2} = [0 0 1 1];
...
RefinementX = 12;    % the number of knots inseted in u direction 
