%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%
%  Elastoplastic isogeometric analysis of 2D cooks a prescribed 
...
tol = 1e-8;
side_node_1 = find( abs(mesh.coords(:,1)-48) < tol );   % right boundary
...
% dbc = [dbc; side_node_1,   2*ones(length(side_node_1),1),   4.23*10^-1*ones(length(side_node_1),1)];
